...
class SVHN(data.Dataset):
    ...
    def __init__(self, root, split='label',
                 transform=None, target_transform=None, download=False, label_num=1000, boundary=0):
...
if __name__ == '__main__':
    ...
    labelset = SVHN('./dataset', split='label', download=True, transform=None, boundary=0)
    unlabelset = SVHN('./dataset', split='unlabel', download=True, transform=None, boundary=0)
