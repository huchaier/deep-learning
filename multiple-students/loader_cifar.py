...
class CIFAR10(data.Dataset):
    ...
    def __init__(self, root, split='label',
                 ...
                 download=False, label_num=4000, boundary=0):
        ...
        if self.split is 'label' or self.split is 'unlabel' or self.split is 'valid':
            ...
            for i in range(self.train_data.shape[0]):
                ...
                # 每类提取400作为标记数据
                elif num_labels_train[tmp_label] < label_num:
...
if __name__ == '__main__':
    ...
    labelset = CIFAR10('./dataset', split='label', download=True, transform=None, boundary=0)
    unlabelset = CIFAR10('./dataset', split='unlabel', download=True, transform=None, boundary=0)
